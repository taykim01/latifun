        ...
        json_schema: {
          ...
          schema: {
            ...
            properties: {
              ...
              name: {
                type: "string",
                description: "The name of file, same as use-case name, do not use extension like .ts",
              },
            },
          },
        },
